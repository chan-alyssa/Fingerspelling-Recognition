...
def main():
    ...
    h5_file_path = f'{video_path}.h5'
    frame_number=0

    hf = h5py.File(h5_file_path, 'w')
    g1 = hf.create_group('video')
    d1 = np.zeros((num_frames,316 + 7))
    str_dtype = h5py.string_dtype(encoding='utf-8')
    g1.create_dataset('hand_pose', (num_frames, 316 + 7))
    # g1.create_dataset('video_name', (num_frames, 1), dtype='i8') 
    # g1.create_dataset('label', (num_frames, 1))
    # g1.create_dataset('subtitle', (num_frames,), dtype=str_dtype)
