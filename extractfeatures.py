...
def main():
    ...
    for h5file_name in os.listdir(args.in_folder):
        ...
        hf = h5py.File(f'{h5file_path}f86.h5', 'w')
        g1 = hf.create_group('video')
        g1.create_dataset('features86', (total_frames, 86))
        data1 = hf['video/features86']
        g1.create_dataset('features384', (total_frames, 384))
        data2 = hf['video/features384']
        g1.create_dataset('label', (total_frames, 1))
        data10 = hf['video/label']
